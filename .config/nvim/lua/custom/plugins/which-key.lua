	...
	{ -- Useful plugin to show you pending keybinds.
		...
		opts = {
			...
			spec = {
				...
				{ "<leader>cn", group = "[C]opy current file [n]ame", icon = { icon = "📑" } },
				{ "<leader>cr", group = "[C]opy [r]elative file path", icon = { icon = "📑" } },
				{ "<leader>cf", group = "[C]opy absolute [f]ile path", icon = { icon = "📑" } },
			},
		},
	},
}
