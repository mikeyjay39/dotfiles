...
vim.keymap.set("n", "<leader>sGd", ":FzfLua git_diff<CR>", { desc = "[s]earch [G]it [d]iff" })
vim.keymap.set("n", "<leader>sGf", ":FzfLua git_files<CR>", { desc = "[s]earch [G]it [f]iles" })
vim.keymap.set("n", "<leader>sGs", ":FzfLua git_status<CR>", { desc = "[s]earch [G]it [s]tatus" })
